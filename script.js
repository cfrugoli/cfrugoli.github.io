...
// Transposition amount variable
let slider = document.getElementById("transposeSlider");
...
const midiProcess = function (midiIN, transposition) {
...
dropIns.addEventListener("change", function () {
  ...
  myInput.addListener("noteoff", function (someMIDI) {
    ...
    myOutput.sendNoteOff(midiProcess(someMIDI, parseInt(slider.value)));
  });
});
